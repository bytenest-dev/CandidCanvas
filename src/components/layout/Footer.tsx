    ...
    <footer className="bg-[#111827] text-white">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          {/* ByteNest credit */}
          <a
            href="https://www.bytenest.pro.bd"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2.5 px-4 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 transition-all duration-300"
          >
            <div className="relative">
              <img
                src={devImg}
                alt="ByteNest"
                className="h-6 w-6 object-contain rounded-full ring-1 ring-white/20 group-hover:ring-white/40 transition-all opacity-80 group-hover:opacity-100"
              />
              <span className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-green-400 rounded-full border border-[#111827]" />
            </div>
            <div className="flex flex-col">
              <span className="text-[10px] text-white/35 group-hover:text-white/60 transition-colors leading-none tracking-wider uppercase">Built by</span>
              <span className="text-xs font-semibold text-white/60 group-hover:text-white/90 transition-colors leading-none mt-0.5 tracking-wide">ByteNest</span>
            </div>
            <svg className="w-3 h-3 text-white/20 group-hover:text-white/50 transition-colors ml-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
